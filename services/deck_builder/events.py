...
CODE_LINKS = {
    "service": f"{REPO_BASE}/services/deck_builder/service.py",
    "workflow": f"{REPO_BASE}/services/deck_builder/workflow.py",
    "agents": f"{REPO_BASE}/services/deck_builder/agents.py",
    "state": f"{REPO_BASE}/services/deck_builder/state.py",
    "prompts": f"{REPO_BASE}/services/deck_builder/prompts.py",
    "models": f"{REPO_BASE}/services/deck_builder/models.py",
    "debug": f"{REPO_BASE}/services/deck_builder/debug.py",
    "search_executor": f"{REPO_BASE}/services/deck_builder/executors/search.py",
    "offer_executor": f"{REPO_BASE}/services/deck_builder/executors/offer.py",
    "critique_executor": f"{REPO_BASE}/services/deck_builder/executors/critique.py",
    "judge_executor": f"{REPO_BASE}/services/deck_builder/executors/judge.py",
    "search_service": f"{REPO_BASE}/services/search_service.py",
    "azure_search": f"{REPO_BASE}/services/azure_search_service.py",
    "pptx_merger": f"{REPO_BASE}/services/pptx_merger.py",
}
