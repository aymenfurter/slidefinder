...
/**
 * Sets up slide assistant event listeners.
 */
function setupSlideAssistantListeners() {
    // Initialize slide assistant (sets up internal event listeners)
    initSlideAssistant();
